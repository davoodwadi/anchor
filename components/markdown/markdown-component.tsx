...
export const markdownComponents: Components = {
  ...
  // Paragraphs
  p: ({ children }) => (
    <p className="text-base leading-7 my-5 text-card-foreground">{children}</p>
  ),
  ...
  li: ({ children }) => (
    <li className="text-base leading-7 text-card-foreground/80">{children}</li>
  ),
...
/** Renders markdown prose without any card/wrapper styling. */
export function MarkdownContent({ children }: MarkdownComponentProps) {
